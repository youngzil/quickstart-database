...
ALTER TABLE AOP_PAGE_APP_RELATION ADD COLUMN RELATION_TYPE VARCHAR(2) COMMENT '关联类型，P页面关联关系，B业务场景关联关系';
ALTER TABLE AOP_PAGE_API_RELATION ADD COLUMN RELATION_TYPE VARCHAR(2) COMMENT '关联类型，P页面关联关系，B业务场景关联关系';
ALTER TABLE AOP_PAGE_OPEN ADD COLUMN PAGE_TYPE VARCHAR(2) COMMENT '页面类型，P页面，B场景';

ALTER TABLE AOP_PAGE_APP_RELATION ALTER COLUMN RELATION_TYPE SET DEFAULT 'P';
ALTER TABLE AOP_PAGE_API_RELATION ALTER COLUMN RELATION_TYPE SET DEFAULT 'P';
ALTER TABLE AOP_PAGE_OPEN ALTER COLUMN PAGE_TYPE SET DEFAULT 'P';
UPDATE AOP_PAGE_APP_RELATION SET RELATION_TYPE = 'P';
UPDATE AOP_PAGE_API_RELATION SET RELATION_TYPE = 'P';
UPDATE AOP_PAGE_OPEN SET PAGE_TYPE = 'P';
